                        ...
                        <tbody className="divide-y divide-slate-100">
                            {transporters?.map((trp) => (
                                <tr key={trp.id} className="transition-colors hover:bg-slate-50/50">
                                    ...
                                    <td className="px-6 py-4 text-slate-600">{trp.cuit}</td>
                                    <td className="px-6 py-4 text-slate-600">
                                        <div className="flex flex-col">
                                            <span className="text-sm font-medium">{trp.contact_email || "Sin email"}</span>
                                            <span className="text-xs text-slate-500 mt-0.5">{trp.address || "Sin dirección"}</span>
                                        </div>
                                    </td>
